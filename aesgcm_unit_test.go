...
func Test_XXXaesgcm_Seal_4blocks(t *testing.T) {
	...
	instance.SetIV(nonce)
	_, _, _ = instance.Encrypt(additionalData, message)
	actual := fmt.Sprintf("%x", message)
	assertEqualsString(t, "42831ec2217774244b7221b784d0d49ce3aa212f2c02a4e035c17e2329aca12e21d514b25466931c7d8f6a5aac84aa051ba30b396a0aac973d58e091473f5985", actual) // +"4d5c2af327cd64a62cf35abd2ba6fab4", actual)
}
...
func Test_xxxFuz(t *testing.T) {
	var additionalData []byte
	for iterations := 0; iterations < 500; iterations++ {
		var length1 = rand.Intn(100) * 16
